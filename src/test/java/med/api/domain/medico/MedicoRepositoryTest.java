...
import med.api.domain.agendamento.Consulta;
...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deveria devolver null quando unico médico não esta disponível na data")
    void escolherMedicoAleatorioNaDataCenario1() {
        //given
        var proximaSegundaAs10 = LocalDate.now()
                .with(TemporalAdjusters
                        .next(DayOfWeek.MONDAY)).atTime(10,0);
        var medico = cadastrarMedico("MedicoTeste","medico@email.com","123456",Especialidade.CARDIOLOGIA);
        var paciente = cadastrarPaciente("PacienteTeste", "paciente@email.com", "12345678999");
    ...
    @Test
    @DisplayName("Não deveria devolver medico quando médico cadastrado tem especialidade diferente")
    void escolherMedicoAleatorioNaDataCenario3() {
        //given
        var proximaSegundaAs10 = LocalDate.now()
                .with(TemporalAdjusters
                        .next(DayOfWeek.MONDAY)).atTime(10,0);
        var medico = cadastrarMedico("MedicoTeste","medico@email.com","123456",Especialidade.DEMARTOLOGIA);
